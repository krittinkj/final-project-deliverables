...
simple\_sam\_detector &
Object segmentation&
\texttt{/vision/run\_pipeline}, \texttt{/vision/detect\_objects},
\texttt{/vision/show\_depth\_image},\\
& & publishes \texttt{/vision/sam\_detections} \\
\hline

clip\_classifier &
Zero-shot semantic classification &
\texttt{/vision/classify\_all}, \texttt{/vision/classify\_bb},
\texttt{/vision/find\_obj},\\
& & subscribes to \texttt{/vision/sam\_detections} \\
\hline

graspnet\_detector &
6-DoF grasp pose estimation &
\texttt{/vision/detect\_grasp}, \texttt{/vision/detect\_grasp\_bb},\\
& & subscribes to \texttt{/vision/sam\_detections} \\
\hline

scene\_understanding &
Relational reasoning &
\texttt{/vision/understand\_scene}, publishes \texttt{/vision/scene\_understanding},\\
& & subscribes to \texttt{/vision/sam\_detections} \\
\hline

pixel\_to\_real &
Pixel-to-world coordinate conversion &
Subscribes to \texttt{/camera/depth/image\_raw},\\
& & service: \texttt{/vision/pixel\_to\_real} \\
\hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{images/vision_service2.png}
